...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_geometry_util__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_matrix_util__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__notifier__ = __webpack_require__(1);
/**
 *
 * Author: iswear(471291492@qq.com)
 * Date: 2017/8/12
...
/* harmony default export */ __webpack_exports__["a"] = ((
  function () {
    ...
    var Node = (function () {
      var id = 0;
      var InnerNode = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].extend(__WEBPACK_IMPORTED_MODULE_3__notifier__["a" /* default */]);
      ...
      InnerNode.prototype.init = function (conf) {
        ...
        this.x = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.x, this.defX);
        this.y = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.y, this.defY);
        this.rotateZ = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.rotateZ, this.defRotateZ);
        this.scaleX = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.scaleX, this.defScaleX);
        this.scaleY = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.scaleY, this.defScaleY);
        this.shearX = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.shearX, this.defShearX);
        this.shearY = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.shearY, this.defShearY);
        this.width = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.width, this.defWidth);
        this.height = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.height, this.defHeight);
        this.anchorX = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.anchorX, this.defAnchorX);
        this.anchorY = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.anchorY, this.defAnchorY);
        this.alpha = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.alpha, this.defAlpha);
        this.visible = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.visible, this.defVisible);
        this.cursor = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.cursor, this.defCursor);
        this.interactive = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.interactive, this.defInteractive);
        this.dirtyRenderSupport = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.dirtyRenderSupport, this.defDirtyRenderSupport);
        this.clip = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.clip, this.defClip);
        this.parent = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.parent, null);
        this.application = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.application, null);

        this._id = ++id;

        this._childNodes =  {
          count: 0, 
          defLayer: __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.defLayer, this.defLayer), 
          nodeLayers: []
        };
        this._transformCtx = {
          localInvalid: false,
      ...
      InnerNode.prototype._syncTransform = function (parentWTransform, parentWReverseTransform, renderZone, parentUpdateTransform) {
        ...
        dirtyCtx.isZoneCross = localZone.width > 0 && localZone.height > 0 && __WEBPACK_IMPORTED_MODULE_0__utils_geometry_util__["a" /* default */].isZoneCross(renderZone, localZone);
              ...
              if (dirtyCtx.oriReported) {
                ...
                if (selfDirtyZone !== null) {
                  for (var i = 0, len = dirtyZones.length; i < len; ++i) {
                    ...
                    if (__WEBPACK_IMPORTED_MODULE_0__utils_geometry_util__["a" /* default */].isZoneCross(dirtyZone, selfDirtyZone)) {
                      result = app.receiveDirtyZone(this, selfDirtyZone);
                      dirtyCtx.curReported = true;
                      break;
                    }
          ...
          if (this.clip) {
            ...
            if (dirtyCtx.isZoneCross) {
              ...
              if (dirtyCtx.curReported) {
                ...
                var crossDirtyZones = [];
                for (var i = 0, len = dirtyZones.length; i < len; ++i) {
                  var crossDirtyZone = __WEBPACK_IMPORTED_MODULE_0__utils_geometry_util__["a" /* default */].getZoneCross(worldZone, dirtyZones[i]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_common_core_application__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_common_core_render_webgl_webgl_render__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_common_ui_ui_view__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_common_ui_ui_label__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_common_game_g_scene__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_common_game_map_g_map__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_common_game_model_g_model__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__src_common_game_g_util__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_common_utils_number_util__ = __webpack_require__(30);
...
/* harmony default export */ __webpack_exports__["a"] = ((function () {
    ...
    var Application = (function () {
      ...
      InnerApplication.prototype.init = function (conf) {
        ...
        this._render = new __WEBPACK_IMPORTED_MODULE_8__render_canvas_canvas_render__["a" /* default */]({canvas: conf.canvas, width: conf.width, height: conf.height});
        this._renderZone = {
          top: 0,
          left: 0,
          right: 0,
      ...
      InnerApplication.prototype.receiveDirtyZone = function (node, dirtyZone) {
        ...
        while (true) {
          ...
          for (var i = dirtyZones.length - 1; i >= 0; --i) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_1__utils_geometry_util__["a" /* default */].isZoneCross(zone, dirtyZone)) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__notifier__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_matrix_util__ = __webpack_require__(7);
/**
 *
...
/* harmony default export */ __webpack_exports__["a"] = ((
  function () {
    ...
    var WebglRender = (function () {
      var InnerWebglRender = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].extend(__WEBPACK_IMPORTED_MODULE_0__notifier__["a" /* default */]);

      InnerWebglRender.prototype.init = function (conf) {
        this.super('init', [ conf ]);
        this.x = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.x, 0);
        this.y = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.y, 0);
        this.width = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.width, this.$canvas.width);
        this.height = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.height, this.$canvas.height);

        this._canvas = __WEBPACK_IMPORTED_MODULE_1__utils_lang_util__["a" /* default */].checkAndGet(conf.canvas, null);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_proxy__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__g_model_util__ = __webpack_require__(28);
/**
 *
 * Author: iswear(471291492@qq.com)
 * Date: 2017/8/15
        ...
        if (conf) {
          ...
          if (nodes) {
            ...
            while (queue.length > 0) {
              ...
              var itemNode = new __WEBPACK_IMPORTED_MODULE_4__g_model_node__["a" /* default */](itemConf.property);
          ...
          for (var i = 0, len = actionGroups.length; i < len; ++i) {
            ...
            for (var i = 0, leng = actions.length; j < leng; ++i) {
              ...
              for (var nodeId in frames) {
                ...
                var animation = __WEBPACK_IMPORTED_MODULE_5__g_model_util__["a" /* default */].compilePropertiesFrames(node, nodeFrames);
                if (animation) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_animation_property_animation__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_animation_queue_animation__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_animation_scheduler_animation__ = __webpack_require__(9);
/**
 *
 * Author: iswear(471291492@qq.com)
 * Date: 2017/8/18
    ...
    compileModelFrames: function(node, frames, isRoot) {
      if (frames && frames.length > 0) {
        ...
        for (var i = 0, len = frames.length; i < len; ++i) {
              ...
              if (!__WEBPACK_IMPORTED_MODULE_0__utils_lang_util__["a" /* default */].isUndefined(currProp) && prevProp !== currProp) {
                ...
                if (tweenNodeProps[props[i2]]) {
                  if (
                    ...
                    params[7] = deltaProp;
                    syncQueue.push(
                      new __WEBPACK_IMPORTED_MODULE_1__core_animation_property_animation__["a" /* default */]({
                        property: props[i2],
                        offset: deltaProp,
                  ...
                  asyncQueue.push(
                    new __WEBPACK_IMPORTED_MODULE_3__core_animation_scheduler_animation__["a" /* default */]({
          ...
          if (asyncQueue.length > 0) {
            syncQueue.push(
              new __WEBPACK_IMPORTED_MODULE_2__core_animation_queue_animation__["a" /* default */]({
                animations: asyncQueue,
                sync: false
              })
            );
