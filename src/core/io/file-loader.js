...
export default (
  function () {
    ...
    var FileLoader = LangUtil.extend(Notifier);

    FileLoader.prototype.init = function (conf) {
    ...
    FileLoader.prototype.loadImageAsync = function (url, fn, target) {
    ...
    FileLoader.prototype.loadAudioAsync = function (url, fn, target) {
    ...
    FileLoader.prototype.loadVideoAsync = function (url, fn, target) {
    ...
    FileLoader.prototype.removeImage = function (url) {
    ...
    FileLoader.prototype.removeAudio = function (url) {
    ...
    FileLoader.prototype.removeVideo = function (url) {
